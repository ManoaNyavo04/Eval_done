                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($result as $resultat)
                                <tr @if (count($pointsGroups[$resultat->points]) > 1) class="highlight" @endif>
                                    <td>
                                        <a href="{{route('classement.details_points_eq_cate', ['id_categorie'=>$id_categorie, 'id_equipe'=>$resultat->id_equipe]) }}">
                                            {{ $resultat->nom }}
                                        </a>
                                        {{-- <form action="{{ route('classement.details_points_eq_cate') }}" method="get">
                                            @csrf
                                            <input type="text" name="id_categorie" value="{{$id_categorie}}" id="">
                                            <input type="text" name="id_equipe" value="{{$resultat->$id_equipe}}" id="">
                                        </form> --}}
                                        {{-- {{ $resultat->nom }} --}}
                                    </td>
